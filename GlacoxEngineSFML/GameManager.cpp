...
GameManager::GameManager() {
    ...
    Player* a1 = new Player(sf::Vector2f(startXA + 100, 360.f), behaviour, Team::TeamA);
    Player* a2 = new Player(sf::Vector2f(startXA - 10 , 100.f), behaviour, Team::TeamA);
    Player* a3 = new Player(sf::Vector2f(startXA - 10, 620.f), behaviour, Team::TeamA);

    float startXB = mField->getRightTryLine() - 10.f;
    Player* b1 = new Player(sf::Vector2f(startXB - 50, 360.f), behaviour, Team::TeamB);
    Player* b2 = new Player(sf::Vector2f(startXB + 10, 420.f), behaviour, Team::TeamB);
    Player* b3 = new Player(sf::Vector2f(startXB + 10, 420.f), behaviour, Team::TeamB);
